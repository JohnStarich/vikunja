...
func defaultWeights() []*UrgencyWeight {
	...
	return []*UrgencyWeight{
		{UserID: -1, Property: UrgencyDueDate.String(), Weight: 100},
		{UserID: -1, Property: UrgencyPercentDone.String(), Weight: 100},
		{UserID: -1, Property: UrgencyPriority.String(), Weight: 10},
	}
}
